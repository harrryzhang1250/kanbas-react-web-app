...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills" id="wd-toc">
      ...
      <li className="nav-item"><a id="wd-github" href="https://github.com/harrryzhang1250/kanbas-react-web-app"
                                  className="nav-link" target="_blank">Github Repository</a></li>
    </ul>
  );
}
